...
public class VariableFinder {
    ...
    public List<Insert> find(XWPFDocument document, Variables variables) {
        ...
        findInHeaders(document, inserts, keys);
        findInFooters(document, inserts, keys);

        mergeTableInserts(inserts, variables);
        return inserts;
    }

	public void findInFooters(XWPFDocument document, List<Insert> inserts, List<Key> keys) {
	...
	public void findInHeaders(XWPFDocument document, List<Insert> inserts, List<Key> keys) {

 ...
 *
 */
public class TestTabsTemplate extends AbstractMetaTest {

    @Test
    public void test() throws IOException {
        String templateFileName = "meta/tabs-template";
        ...
        assertEquals("This is test simple template with three variables: value011, 	value022, 	value033.",
                text.trim());
    }

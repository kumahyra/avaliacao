 ...
 *
 */
public class TestTableObjectTemplate05 extends AbstractTableVariableTest {

    @Test
    public void test() throws IOException {
        String templateFileName = "variable/table/table-object-template-05";
        ...
        TableVariable tableVariable = new TableVariable();
        {
            ...
            columnVariables.add(new ObjectVariable("$P{var1}", new ObjectContainer(new ObjectContainer("value2")),
                    docx.getVariablePattern()));
            columnVariables
                    .add(new ObjectVariable("$P{var1}", new ObjectContainer("value3"), docx.getVariablePattern()));
            columnVariables
        ...
        expected += "№		Name\n";
        expected += "	value1\n";
        expected += "	ObjectContainer [value=value2]\n";
        expected += "	value3\n";
        expected += "	value4\n";
        expected += "\n";
        expected += "\n";

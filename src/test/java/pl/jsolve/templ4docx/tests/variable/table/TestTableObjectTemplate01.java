 ...
 *
 */
public class TestTableObjectTemplate01 extends AbstractTableVariableTest {

    @Test
    public void test() throws IOException {
        String templateFileName = "variable/table/table-object-template-01";
        ...
        TableVariable tableVariable = new TableVariable();
        {
            ...
            columnVariables.add(new TextVariable("$P{textRowVar1}", "textRowValue4"));
